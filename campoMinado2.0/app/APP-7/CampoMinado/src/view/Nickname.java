...
public class Nickname extends javax.swing.JDialog {

    NickNameControler controllerNick;
    
    public Nickname(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.getContentPane().setBackground(Color.getHSBColor(35, 5, 34));
        this.setLocationRelativeTo(null);
        controllerNick = new NickNameControler();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Informe o nome do Jogador :");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Nickname dialog = new Nickname(new javax.swing.JFrame(), true);
